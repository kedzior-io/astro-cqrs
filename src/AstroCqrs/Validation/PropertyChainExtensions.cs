...
internal static class PropertyChainExtensions
{
    ...
    private static object? GetValue(BinaryExpression expression)
    {
    ...
    private static object? GetValueCompiled(Expression expression)
