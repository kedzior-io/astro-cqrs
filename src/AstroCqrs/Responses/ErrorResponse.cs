...
//    public Task ExecuteAsync(HttpContext httpContext) => httpContext.Response.SendAsync(this, StatusCode);

//#if NET7_0_OR_GREATER
//    private static readonly string[] _item = { "application/problem+json" };
